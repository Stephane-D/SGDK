...
u16 executeBGTest(u16 *scores)
{
    ...
    *score = displayResult(10000, end - start, 2);
    ...
    while(i--)
    {
        ...
        while(j)
        {
            VDP_drawImageEx(PLAN_A, &logo_med, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_med, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_med, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
    ...
    *score = displayResult(300, end - start, 2);
    ...
    while(i--)
    {
        ...
        while(j)
        {
            VDP_drawImageEx(PLAN_A, &logo_med_f, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_med_f, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_med_f, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
    ...
    *score = displayResult(800, end - start, 2);
    ...
    while(i--)
    {
        ...
        while(j)
        {
            VDP_drawImageEx(PLAN_A, img, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, img, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, img, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
    ...
    *score = displayResult(5000, end - start, 2) / 5;
    ...
    while(i--)
    {
        ...
        while(j)
        {
            VDP_drawImageEx(PLAN_A, &logo_sm, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_sm, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_sm, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
    ...
    *score = displayResult(1000, end - start, 2);
    ...
    while(i--)
    {
        ...
        while(j)
        {
            VDP_drawImageEx(PLAN_A, &logo_sm_f, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_sm_f, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
            pos++;
            VDP_drawImageEx(PLAN_A, &logo_sm_f, TILE_ATTR_FULL(PAL1, FALSE, FALSE, FALSE, TILE_USERINDEX), pos->x, pos->y, TRUE, TRUE);
